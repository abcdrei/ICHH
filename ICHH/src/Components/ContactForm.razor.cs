...
public partial class ContactForm
{
    ...
    protected async Task Submit()
    {
        ...
        try
        {
            ...
            var htmlBody = await htmlRenderer.Dispatcher.InvokeAsync(async () =>
            {
                var output = await htmlRenderer.RenderComponentAsync<ContactEmailTemplate>(
                    ParameterView.FromDictionary(new Dictionary<string, object?>
                    {
                        ...
                        { nameof(ContactEmailTemplate.Phone),   FormInput.Phone },
                        { nameof(ContactEmailTemplate.Subject), FormInput.Subject },
            ...
            message.Subject = $"New Referral Form Submission from {FormInput.Name}";
        ...
        {
            IsSuccess = false;
            StatusMessage = "Failed to send your message. Please try again or email us.";
